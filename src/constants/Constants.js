...
const GAME_MODE = "Time based word guess mode";
const HINT_BUTTON_TOOLTIP_TITLE = "Show Hint";
const RESET_BUTTON_TOOLTIP_TITLE = "New word for guessing";
...
export {
  ...
  VOCAB_MODE,
  SELECTIVE_MODE,
  HINT_BUTTON_TOOLTIP_TITLE,
  RESET_BUTTON_TOOLTIP_TITLE,
  HINT_LIMIT
};
