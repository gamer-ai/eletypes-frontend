...
const MusicPlayer = ({disabled, isZenMode}) => {
  const players = {
    spotify:
      '<iframe style="border-radius:20px" src="https://open.spotify.com/embed/playlist/2HeW8KNgI5nOZf0yOdO6Mf?utm_source=generator&theme=0" width="100%" height="300" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>',
